...
def get_mock_registers():
    ...
    return [
        ...
        mock(name='ctl.field_weaken', type_id=ValueType.BOOLEAN, cached=[False], default=[False], min=[False],
             max=[True], mutable=True, persistent=True, ts_device=167.283183261, ts_mono=11474.09518067),
        ...
        mock(name='setpoint.iq_limit', type_id=ValueType.F32, cached=[0.0], default=None, min=None,
             max=None, mutable=False, persistent=False, ts_device=168.789075761, ts_mono=11474.097282835),
        mock(name='setpoint.id_fealdweakening', type_id=ValueType.F32, cached=[0.0], default=None, min=None,
             max=None, mutable=False, persistent=False, ts_device=168.789075761, ts_mono=11474.097282835),
